...
var Footer = function Footer(_a) {
  var children = _a.children,
    ...
    otherProps = __rest(_a, ['children', 'copyright']);

  var themeName = useThemeContext_1.useThemeContext().themeName;
  return react_1.default.createElement(
    ...
    children
      ? react_1.default.createElement(
          styles_1.StyledText,
          {
            variant: components_1.TYPOGRAPHY_VARIANTS.description,
...
Footer.propTypes = {
  /**
   * Задает остновной текст
   */
  children: PropTypes.node,
  /**
   * Задает текст с авторским правом
   */
